...
var GlassMode = /* @__PURE__ */ ((GlassMode2) => {
...
const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const customFilterStyle = vue.computed(() => {
      return {
        position: "absolute",
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("svg", {
        style: vue.normalizeStyle(customFilterStyle.value),
        "aria-hidden": "true"
      }, [
...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    vue.watch(() => [props.mode, props.glassSize.width, props.glassSize.height, props.effect], async () => {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(`relative ${_ctx.className} ${_ctx.active ? "active" : ""} ${Boolean(_ctx.onClick) ? "cursor-pointer" : ""}`),
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const glassRef = vue.ref();
    const isHovered = vue.ref(false);
    const isActive = vue.ref(false);
    const glassSize = vue.ref({ width: 270, height: 69 });
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass(`bg-black transition-all duration-150 ease-in-out pointer-events-none ${_ctx.overLight ? "opacity-20" : "opacity-0"}`),
          style: vue.normalizeStyle({
        ...
        vue.createElementVNode("div", {
          class: vue.normalizeClass(`bg-black transition-all duration-150 ease-in-out pointer-events-none mix-blend-overlay ${_ctx.overLight ? "opacity-100" : "opacity-0"}`),
          style: vue.normalizeStyle({
            ...positionStyles.value,
            height: glassSize.value.height,
            width: glassSize.value.width,
        ...
        vue.createElementVNode("span", {
          style: vue.normalizeStyle({
            ...positionStyles.value,
            height: vue.unref(autoPx)(glassSize.value.height),
            width: vue.unref(autoPx)(glassSize.value.width),
            borderRadius: `${_ctx.cornerRadius}px`,
            transform: baseStyle.value.transform,
            transition: baseStyle.value.transition,
            pointerEvents: "none",
        ...
        Boolean(_ctx.onClick) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
          vue.createElementVNode("div", {
            style: vue.normalizeStyle({
              ...positionStyles.value,
              height: vue.unref(autoPx)(glassSize.value.height),
              width: vue.unref(autoPx)(glassSize.value.width) + 1,
              borderRadius: `${_ctx.cornerRadius}px`,
              transform: baseStyle.value.transform,
              pointerEvents: "none",
...
exports.GlassContainer = _sfc_main$1;
exports.GlassFilter = _sfc_main$2;
exports.GlassMode = GlassMode;
exports.LiquidGlass = _sfc_main;
exports.ShaderDisplacementGenerator = ShaderDisplacementGenerator;
